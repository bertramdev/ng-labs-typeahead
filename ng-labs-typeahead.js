...
.directive('typeahead', ['$parse', function($parse){
	...
	return {
		...
		template: '<input type="text" class="labs-typeahead"><span class="labs-typeahead-dropdown-symbol"><i class="typeahead-icon-arrow-down"></i></span><ol class="labs-typeahead-list" style="display:none;"><li class="labs-typeahead-loading">Loading!</li><li class="labs-typeahead-empty">No Results!</li><li class="labs-typeahead-list-item" ng-transclude></li></ol>',
		// templateUrl: '',
		// replace: true,
		transclude: true,
